...
public class StockItem implements Serializable {
    ...
    private StockTransaction trans;
    ...
    public StockTransaction getTrans() {
        return trans;
    }

    public StockItem trans(StockTransaction stockTransaction) {
        this.trans = stockTransaction;
        return this;
    }

    public void setTrans(StockTransaction stockTransaction) {
        this.trans = stockTransaction;
    }
