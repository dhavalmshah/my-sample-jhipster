...
export class ContactUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    id: [],
    firstName: [null, [Validators.required, Validators.maxLength(255), Validators.pattern('^[A-Z][a-z]+$')]],
    lastName: [null, [Validators.required, Validators.maxLength(255), Validators.pattern('^[A-Z][a-z]+$')]],
    designation: [null, [Validators.maxLength(255), Validators.pattern('^[A-Z][a-z]+$')]],
