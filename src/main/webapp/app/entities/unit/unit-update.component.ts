...
export class UnitUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    ...
    baseUnitMultiplier: [null, [Validators.required]],
    isSmallerThanBase: [null, [Validators.required]],
  });
  ...
  updateForm(unit: IUnit): void {
    this.editForm.patchValue({
      ...
      isSmallerThanBase: unit.isSmallerThanBase,
    });
  }
  ...
  private createFromForm(): IUnit {
    return {
      ...
      baseUnitMultiplier: this.editForm.get(['baseUnitMultiplier'])!.value,
      isSmallerThanBase: this.editForm.get(['isSmallerThanBase'])!.value,
    };
  }
