...
public class ContactResourceIT {
    ...
    private static final String DEFAULT_FIRST_NAME = "Jolio";
    private static final String UPDATED_FIRST_NAME = "Yvw";

    private static final String DEFAULT_LAST_NAME = "Dahb";
    private static final String UPDATED_LAST_NAME = "Qwmmn";

    private static final String DEFAULT_DESIGNATION = "Raxslm";
    private static final String UPDATED_DESIGNATION = "Nsredx";
