...
public class AddressResourceIT {
    ...
    private static final String DEFAULT_BUILDING_ADDRESS = "AAAAAAAAAA";
    private static final String UPDATED_BUILDING_ADDRESS = "BBBBBBBBBB";
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address()
            .buildingAddress(DEFAULT_BUILDING_ADDRESS)
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address()
            .buildingAddress(UPDATED_BUILDING_ADDRESS)
    ...
    public void createAddress() throws Exception {
        ...
        assertThat(testAddress.getBuildingAddress()).isEqualTo(DEFAULT_BUILDING_ADDRESS);
    ...
    @Test
    @Transactional
    public void checkBuildingAddressIsRequired() throws Exception {
        int databaseSizeBeforeTest = addressRepository.findAll().size();
        // set the field null
        address.setBuildingAddress(null);
    ...
    public void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].buildingAddress").value(hasItem(DEFAULT_BUILDING_ADDRESS)))
    ...
    public void getAddress() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses/{id}", address.getId()))
            ...
            .andExpect(jsonPath("$.buildingAddress").value(DEFAULT_BUILDING_ADDRESS))
    ...
    public void updateAddress() throws Exception {
        ...
        Address testAddress = addressList.get(addressList.size() - 1);
        assertThat(testAddress.getBuildingAddress()).isEqualTo(UPDATED_BUILDING_ADDRESS);
