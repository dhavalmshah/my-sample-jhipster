...
import com.dhavalapp.com.repository.ProductRepository;
import com.dhavalapp.com.service.ProductService;
...
public class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        ...
        if (TestUtil.findAll(em, ProductAlias.class).isEmpty()) {
            productAlias = ProductAliasResourceIT.createEntity(em);
            em.persist(productAlias);
            em.flush();
        } else {
            productAlias = TestUtil.findAll(em, ProductAlias.class).get(0);
        }
        product.getAliases().add(productAlias);
        return product;
    }
    /**
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        ...
        ProductAlias productAlias;
        if (TestUtil.findAll(em, ProductAlias.class).isEmpty()) {
            productAlias = ProductAliasResourceIT.createUpdatedEntity(em);
            em.persist(productAlias);
            em.flush();
        } else {
            productAlias = TestUtil.findAll(em, ProductAlias.class).get(0);
