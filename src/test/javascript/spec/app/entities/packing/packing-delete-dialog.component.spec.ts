...
import { PackingDeleteDialogComponent } from 'app/entities/packing/packing-delete-dialog.component';
import { PackingService } from 'app/entities/packing/packing.service';

describe('Component Tests', () => {
  describe('Packing Management Delete Component', () => {
    let comp: PackingDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PackingDeleteDialogComponent, '')
        .compileComponents();
